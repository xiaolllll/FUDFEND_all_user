...
class MultiDomainFENDModel(torch.nn.Module):
    def __init__(self, emb_dim, mlp_dims, dropout):
        ...
        self.gate = nn.Sequential(nn.Linear(emb_dim + self.domain_num, mlp_dims[-1]),
                                  nn.ReLU(),
        ...
        self.rnn_fc_1 = nn.Linear(128, 9)

    def forward(self, text, domain, user_neighbor_index, num_feature, cat_feature, edge_index):
